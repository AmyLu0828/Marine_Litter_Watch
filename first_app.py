...
MLW = pd.read_csv("/Users/zhixinglu/Desktop/DataScience/MLW.csv")
MLWmeta = pd.read_csv("/Users/zhixinglu/Desktop/DataScience/MLW_Meta.csv")
...
cc = pd.read_csv("/Users/zhixinglu/Desktop/DataScience/Countrycode.csv")
...
if option == 'Factors':
    ...
    if show_map == True:
        ...
        with col1:
            st.image('/Users/zhixinglu/Desktop/DataScience/Europe.jpg', caption = "European Map")
        with col2:
            st.image('/Users/zhixinglu/Desktop/DataScience/IMG_1732.JPG', caption = "Different Seas")
        with col3:
            st.image('/Users/zhixinglu/Desktop/DataScience/mapkey.JPG', width = 150)
    #mean median
    st.markdown("")
    st.markdown("")
    ...
    st.image("/Users/zhixinglu/Desktop/DataScience/balticsea.png")
